export const RECEIVE_ADDRESS = 'receive_addredd' // 接收地址
export const RECEIVE_CATEGORYS = 'receive_categorys' // 接收食品分类数组
export const RECEIVE_SHOPS = 'receive_shop' // 接收商家数组
...
export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops' // 搜索商家列表
